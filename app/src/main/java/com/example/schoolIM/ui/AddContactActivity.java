...
public class AddContactActivity extends BaseActivity {
    ...
    public void searchContact(View v) {
        ...
        if (getString(R.string.button_search).equals(saveText)) {
            ...
            OkHttpTools.sendPost(mContext, ApiManager.USER_FIND)
                    .addParams("name", name)
                    .build()
                    .execute(new BaseCallBack<UserObjBean>(mContext, UserObjBean.class) {
                        ...
                        public void onResponse(UserObjBean userObjBean) {
                            if (userObjBean.getData() != null) {
                                ...
                                nameText.setText(userObjBean.getData().getNumber());
                                if (TextUtils.isEmpty(userObjBean.getData().getHead())){
                                    avatar.setImageResource(R.drawable.em_default_avatar);
                                }else{
                                    Glide.with(mContext).load(ApiManager.HEAD_PATH + userObjBean.getData().getHead())
                                            .into(avatar);
                                }
                            }
                        }
